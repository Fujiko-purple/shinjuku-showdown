  ...
  var BGM_TRACKS = [
    ...
    /**
     * 第二首来自 B 站《【循环歌单】"最强之战永久铭刻于新宿."》（早睡起大王，BV1MojB6iEdy，原片 3156 秒）：
     * **从 0:00 开始**截 225 秒（与原曲「雨爱」等长）。开头保持原样，只做了 0.15 秒防爆音淡入；
     * 结尾 2 秒淡出后回到开头循环。响度 -6.8 LUFS，与原曲 -6.5 同档，切换不会突然变响或变轻。
     */
